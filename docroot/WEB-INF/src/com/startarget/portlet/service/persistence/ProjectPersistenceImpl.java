...
import com.startarget.portlet.NoSuchProjectException;
import com.startarget.portlet.model.Project;
import com.startarget.portlet.model.impl.ProjectImpl;
import com.startarget.portlet.model.impl.ProjectModelImpl;
...
public class ProjectPersistenceImpl extends BasePersistenceImpl<Project>
	...
	@Override
	public Project updateImpl(com.startarget.portlet.model.Project project)
	...
	protected Project toUnwrappedModel(Project project) {
		...
		projectImpl.setProjectLeader(project.getProjectLeader());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.startarget.portlet.model.Project")));
