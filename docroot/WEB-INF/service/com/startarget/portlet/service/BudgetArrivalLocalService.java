...
/**
 * Provides the local service interface for BudgetArrival. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author chaojie
 * @see BudgetArrivalLocalServiceUtil
...
public interface BudgetArrivalLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BudgetArrivalLocalServiceUtil} to access the budget arrival local service. Add custom service methods to {@link com.startarget.portlet.service.impl.BudgetArrivalLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
