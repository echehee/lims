 ...
 * @generated
 */
public abstract class BudgetActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public BudgetActionableDynamicQuery() throws SystemException {
		setBaseLocalService(BudgetLocalServiceUtil.getService());
		setClass(Budget.class);

		setClassLoader(com.startarget.portlet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("budgetId");
	}
}