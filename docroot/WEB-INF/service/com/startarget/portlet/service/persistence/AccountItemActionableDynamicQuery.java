 ...
 * @generated
 */
public abstract class AccountItemActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public AccountItemActionableDynamicQuery() throws SystemException {
		setBaseLocalService(AccountItemLocalServiceUtil.getService());
		setClass(AccountItem.class);

		setClassLoader(com.startarget.portlet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("accountItemId");
	}
}