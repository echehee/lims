...
/**
 * The persistence utility for the budget service. This utility wraps {@link BudgetPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class BudgetUtil {
	 ...
	 */
	public static void clearCache(Budget budget) {
		getPersistence().clearCache(budget);
	}
	 ...
	 */
	public static List<Budget> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static Budget update(Budget budget) throws SystemException {
		return getPersistence().update(budget);
	}

	/**
	 * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
	 */
	public static Budget update(Budget budget, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(budget, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.startarget.portlet.model.Budget budget) {
		getPersistence().cacheResult(budget);
	}
	...
	*/
	public static com.startarget.portlet.model.Budget create(long budgetId) {
	...
	*/
	public static com.startarget.portlet.model.Budget remove(long budgetId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.startarget.portlet.NoSuchBudgetException {
		return getPersistence().remove(budgetId);
	}

	public static com.startarget.portlet.model.Budget updateImpl(
		com.startarget.portlet.model.Budget budget)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(budget);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.startarget.portlet.model.Budget findByPrimaryKey(
		long budgetId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.startarget.portlet.NoSuchBudgetException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.startarget.portlet.model.Budget fetchByPrimaryKey(
		long budgetId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.startarget.portlet.model.Budget> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static BudgetPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (BudgetPersistence)PortletBeanLocatorUtil.locate(com.startarget.portlet.service.ClpSerializer.getServletContextName(),
					BudgetPersistence.class.getName());

			ReferenceRegistry.registerReference(BudgetUtil.class, "_persistence");
		}
	 ...
	 */
	public void setPersistence(BudgetPersistence persistence) {
	}

	private static BudgetPersistence _persistence;
}