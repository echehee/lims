 ...
 * @generated
 */
public abstract class BudgetItemActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public BudgetItemActionableDynamicQuery() throws SystemException {
		setBaseLocalService(BudgetItemLocalServiceUtil.getService());
		setClass(BudgetItem.class);

		setClassLoader(com.startarget.portlet.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("budgetItemId");
	}
}